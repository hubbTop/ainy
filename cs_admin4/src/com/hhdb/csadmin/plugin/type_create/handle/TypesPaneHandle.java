...
import com.hhdb.csadmin.plugin.type_create.component.BaseTable;
import com.hhdb.csadmin.plugin.type_create.component.BaseTablePanel;
...
public class TypesPaneHandle extends JPanel{
	...
	public void editPanelEnum(){
		...
		tablePanel.setCellEditor(0, textcellEnum);
	...
	public void editPanelComposite(){
		...
		tablePanel.setCellEditor(0, textcellComposite);
		tablePanel.setCellEditor(1, comboBoxcell);
	}
...
//		baseTable.setBackground(new Color(220, 255, 220));// 表格单元格背景颜色
		...
		tablePanel.setDataList(lists, null);
		addRows();
