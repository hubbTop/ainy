...
import com.hhdb.csadmin.plugin.function.util.BaseTable;
import com.hhdb.csadmin.plugin.function.util.BaseTablePanel;
...
public class HandleFunctionPanel extends JPanel implements CreateTableSQLSyntax, TableModelListener {
	...
	public void initCellEditor() {
		...
		tablePanel.setCellEditor(0, textcell);
		tablePanel.setCellEditor(1, comboBoxcell);
		tablePanel.setCellEditor(2, typecell);
	}
