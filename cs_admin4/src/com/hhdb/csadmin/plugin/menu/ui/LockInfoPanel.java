...
import com.hhdb.csadmin.plugin.menu.util.BaseTable;
import com.hhdb.csadmin.plugin.menu.util.BaseTablePanel;
...
public class LockInfoPanel extends JPanel implements ActionListener{
	...
	public LockInfoPanel(Hmenu hmenu, String sertableId) {
		...
		tablePanel=new BaseTablePanel(false);
	...
	public void loadTable() {
		...
		baseTable.setModel(new DefaultTableModel(rowData, columnNames));
