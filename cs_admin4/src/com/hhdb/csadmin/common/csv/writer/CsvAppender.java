...
public final class CsvAppender implements Closeable, Flushable {
    ...
    private final StringBuffer sbfstr;
    ...
    CsvAppender(final StringBuffer sbf,final Writer writer, final char fieldSeparator, final char textDelimiter,
    ...
    public void appendFieldSbf(final String value) throws IOException {
        if (!newline) {
            //writer.write(fieldSeparator);
        	sbfstr.append(fieldSeparator);
        } else {
            newline = false;
        }
    ...
    public void appendLineSbf(final String... values) throws IOException {
        for (final String value : values) {
            appendFieldSbf(value);
        }
        endLineSbf();
    }
    ...
    public void endLineSbf() throws IOException {
    	sbfstr.append(lineDelimiter);
        newline = true;
    }
